  ...
  return (
    <div className="min-h-screen font-sans bg-white overflow-hidden">
      ...
      <motion.section 
        ...
        className="pt-32 pb-32 bg-gradient-to-br from-brand-primary via-accent-500 to-brand-secondary text-white relative"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Hero Wave Divider */}
        <div className="absolute w-full bottom-0 left-0 -translate-y-4">
