...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-brand-background to-white">
      ...
      <div className="w-full flex justify-center mb-8">
        <Link href="/" className="inline-block">
          <img 
            ...
            alt="MenuFacil"
            className="h-12 w-auto animate-logoFadeIn transition-transform duration-300 hover:scale-105"
          />
        </Link>
      </div>
